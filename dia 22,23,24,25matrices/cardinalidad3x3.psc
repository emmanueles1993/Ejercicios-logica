...
Algoritmo cardinalidad3x3
	...
	Dimension matriz(3,3)  //3 elementos del primer subindice y 3 del segundo subindice//
	...
	Para i<-0 Hasta 2 Con Paso 1 Hacer //filas// primero lee fila en el subindice 0,0
		Para j<-0 Hasta 2 Con Paso 1 Hacer//columnas//segundo lee la columna en el subindice 0
