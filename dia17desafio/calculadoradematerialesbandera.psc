...
SubProceso  calcularTecho()
	...
	v<-calcularVolumen(espesor,largo,ancho) //se llama a la funcion calcularvolumen//
...
SubProceso calcularPintura ()
	...
	Leer base,altura
	superficie=calcularSuperficie(base,altura)//se llama a la funcion calcularsuperficie//
